      ...
      <form onSubmit={onSubmit} className="flex flex-1 flex-col">
        <div className="flex flex-1 flex-col items-center gap-6 px-5 pt-4">
          <button
            ...
            className="border-brand/50 hover:border-brand relative flex h-28 w-28 items-center justify-center overflow-hidden rounded-full border-2 border-dashed bg-card transition-colors"
          >
            {previewUrl ? (
